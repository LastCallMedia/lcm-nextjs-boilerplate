      ...
      <div className="mx-auto flex flex-col items-center justify-center px-6 py-12 lg:px-12">
        ...
        >
          ...
          >
            ...
            >
              Our software optimizes workflows and interactions across the
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300">
              Streamline processes with AI-driven workflows that adapt to
              customer needs
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold">Personalized Experiences</h3>
            <p className="text-gray-300">
              Deliver tailored interactions based on customer history and
              preferences
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">
              Monitor performance and optimize customer journeys with actionable
              insights
            </p>
          </motion.div>
        </motion.div>
